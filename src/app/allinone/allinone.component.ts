...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  {position: 2, type: 'Hospitality', name: 'InterContinental Hotels', price: 250, location: 'Mumbai', book:'/bookhospitality/InterContinentalMarineDrive'},
  {position: 3, type: 'Hospitality', name: 'Marriott International', price: 250, location: 'Bethesda', book: '/bookhospitality/MarriottInternational'},
  {position: 4, type: 'Hospitality', name: 'Radisson Blu Hotels', price: 250, location: 'Hyderabad', book: '/bookhospitality/RadissonBluHotels'},
  ...
  {position: 10, type: 'Tourism', name: 'The Taj Mahal', price: 25, location: 'Agra, India', book: '/booktour/Tajmahal'},
  ...
  {position: 15, type: 'Tourism', name: 'Mumbai: The Gateway of India', price: 25, location: 'Mumbai, India', book: '/booktour/GateWayofIndia'},
  ...
  {position: 22, type: 'Travel', name: 'Goa', price: 25, location: 'Goa, India', book: '/booktravel/Goa'},
